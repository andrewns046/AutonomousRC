...
def drive(cfg, model_path=None, use_joystick=False, model_type=None, camera_type='single', meta=[] ):
    ...
    class DriveMode: ################################################## now sends which mode it is in to PWMthrottle 
        def run(self, mode, 
            ...
            if mode == 'user': 
                ...
                return pilot_angle, user_throttle, False ###################
    ...
    V.add(DriveMode(), 
          ...
          outputs=['angle', 'throttle', 'PIDBoolean']) #######################
    ...
    if cfg.DONKEY_GYM:
        ...
        rpm_sensor = RotaryEncoder(22.1600, 7, 0.05, False) 
        # 
        ...
        V.add(throttle, inputs=['throttle', 'PIDBoolean', "meters_second"])
    ...
    inputs=['cam/image_array',
            'user/angle', 'meters_second', ################################################################################################### THIS IS THE CHANGED LINE
            'user/mode']
